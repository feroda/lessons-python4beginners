...
class FileManager(BaseManager):
    ...
    def _do_export(self, rows):   #metodo da usare solamente all'interno della classe
...
class CsvManager(BaseManager):
    ...
    def get_output(self, rows):
        ...
        myfile = StringIO.StringIO()  #stringIO permette di memorizzare in myfile l'oggetto
                                      #file memorizzandolo su RAM -> evita le operazione I-O su
                                      #file che sono lente
