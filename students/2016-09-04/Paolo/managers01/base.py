class BaseManager(object):
    ...
    def __init__(self, fname, debug=False):
        ...
        self.__privateattr = "PRIVATO"  #Questo è un attributo privato !! Può essere utilizzato solo dentro a questa classe. I due underscore bloccano questa variabile.
                                        #I metodi hanno un solo underscore quando è sconsigliato per l'utente usarli. Il doppio underscore li renderebbe invisibili alle
                                        #sottoclassi
        self.fname = fname
        self.debug = debug
